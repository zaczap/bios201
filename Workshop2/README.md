...
:question: **3. Do you notice anything different in the order in which the
...
:question: **2.1 Take a look at `bam_pass1/Norm1_Log.final.out` and
	   `bam_pass2/Norm1_Log.final.out`. These are summary reports
	   automatically generated by STAR. Do you see fewer unmapped
	   reads in the second pass?**
...
count files, the two you created for Norm1 and IPF1, as well as the ones
